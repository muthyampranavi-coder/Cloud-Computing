      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="HS_DocAutho.jsp">&raquo; View and Authorize Delegator </a></li>
            <li><a href="HS_ProviderAutho.jsp">&raquo; View and Authorize Data Owner </a></li>
            
            <li><a href="HS_ViewDetails.jsp">&raquo; View Patient Details</a></li>
            <li><a href="HS_ViewAccessControl_req.jsp">&raquo;View Access Control Req </a></li>
            <li><a href="HS_Key_Transactions.jsp">&raquo; View Key Transactions</a></li>
            <li><a href="HS_Chart.jsp">&raquo; View Score Results </a></li>
