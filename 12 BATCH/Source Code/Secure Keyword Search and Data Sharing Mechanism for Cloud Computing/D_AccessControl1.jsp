...
try 
	{		
				...
				if ( rs.next() )
				{
					...
					{
%>
                <span class="style26">Request Already Sent For Cloud Server !! <br /> For Patient : <span class="style25">" <%=s2%> "</span></span>
                <%	}
				else
				{					
					...
					{
						%>
                <span class="style26">Requested Access Control To Cloud Server !! <br /> For Patient : <span class="style25">" <%=s2%> "</span></span>
                <%
					}
