      ...
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            ...
            <div class="clr"></div>
            <div >
              <p align="justify"><strong>View  Key Requests From Delegators/Nurse And Generate Key </strong>.</p>
              <p>&nbsp;</p>
              <table width="584" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
                <tr>
                  ...
                  <td width="121" bgcolor="#FF0000"><div align="center" class="style25"> Delegator  Name </div></td>
...
<%	String s1="",s2="",s3="",s4="",s5="",s6="",s7="",s8,s9="",s10,s11,s12,s13;
	...
	try 
	{
		String query="select *from key_request"; 
...
%>      </table>
       <p>&nbsp;</p>
      <div align="right"><a href="HK_Main.jsp">Back</a></div>
            </div>
            <div class="clr"></div>
          </div>
        </div>
