    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="HSP_Login.jsp"><span>Data Owner</span></a></li>
          <li><a href="D_Login.jsp"><span>Delegator</span></a></li>
          ...
          <div>
            ...
            <form action="HSP_RegisterAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
              ...
              <table width="590" height="524" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="259" bgcolor="#FF0000" scope="row"><div align="left" class="style2"> Name (required) : </div></td>
                  <td width="343"><input id="name" name="userid" class="text" /></td>
                </tr>
                <tr>
                  <td bgcolor="#FF0000" ><div align="left" class="style2">Password (required) : </div></td>
                  <td><input type="password" id="password" name="pass" class="text" /></td>
                </tr>
                <tr>
                  <td bgcolor="#FF0000" scope="row"><div align="left" class="style2">Email Address (required) : </div></td>
                  <td><input id="email" name="email" class="text" /></td>
                </tr>
                <tr>
                  <td bgcolor="#FF0000" scope="row"><div align="left" class="style2">Mobile Number (required) : </div></td>
                  <td><input id="mobile" name="mobile" class="text" /></td>
                </tr>
                <tr>
                  <td bgcolor="#FF0000" scope="row"><span class="style3"><strong>
                      <label for="label"> </label>
                      <label for="label">
                      </strong>
                      </span>
                    <div align="left" class="style3"><strong>Your Address : </strong></div>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row"><span class="style3"><strong>
                    ...
                    <div align="left" class="style3"><strong>Date of Birth (required) : </strong></div>
                    <span class="style3"><strong>
                      </label>
                    </strong></span></td>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row"><div align="left" class="style3"><strong>Select Gender (required) : </strong></div></td>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row"><span class="style3"><strong>
                    ...
                    <div align="left" class="style3"><strong>Enter Pincode (required) : </strong></div>
                    <span class="style3"><strong>
                      </label>
                    </strong></span></td>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row"><span class="style3"><strong>
                    ...
                    <div align="left" class="style3"><strong>Enter Location (required) : </strong></div>
                    <span class="style3"><strong>
                      </label>
                    </strong></span></td>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row"><span class="style3"><strong>
                    ...
                    <div align="left" class="style3"><strong>Select Profile Picture (required) : </strong></div>
                    <span class="style3"><strong>
                      </label>
                    </strong></span></td>
