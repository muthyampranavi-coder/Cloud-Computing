...
.style45 {font-size: 14px; font-weight: bold; color: #FF0000; }
-->
</style>
</head>
<body>
          ...
          <div class="article">
            ...
            <div >
              ...
              <table width="580" border="1" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
                <tr>
                  <td width="34" height="34" bgcolor="#FFFF00"><div align="center" class="style22 style43"> ID </div></td>
                  <td width="126" bgcolor="#FFFF00"><div align="center" class="style45">Patient Name </div></td>
                  <td width="132" bgcolor="#FFFF00"><div align="center" class="style45">Provider Name </div></td>
                  <td width="143" bgcolor="#FFFF00"><div align="center" class="style45">View Report </div></td>
                  <td width="133" bgcolor="#FFFF00"><div align="center" class="style45">Status</div></td>
                </tr>
                <%
