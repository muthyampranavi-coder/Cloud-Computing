            ...
            <form action="D_Request_key1.jsp" method="post" id="leavereply">
              <div align="center">
                <table width="523" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <th height="48" bgcolor="#FF0000" scope="row"><div align="center" class="style25"><span class="style17">Enter Provider Name :&nbsp;</span></div></th>
                    <td><div align="left"><span class="style17">
                      <input name="t142" type="text" size="30" />
                    </span></div></td>
                  </tr>
                  <tr>
                    <th height="35" bgcolor="#FF0000" scope="row"><div align="center" class="style25"><span class="style17"> Enter Patient Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div></th>
                    <td><div align="left"><span class="style17">
