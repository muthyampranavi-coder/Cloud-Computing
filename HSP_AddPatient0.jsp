            ...
            <form action="HSP_AddPatient1.jsp" method="post" id="" enctype="multipart/form-data">
			 ...
			 <input type="hidden" name="keys" value="<%=keys%>" />
              ...
              <table width="590" height="851" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="259" height="35" bgcolor="#FFFFFF" scope="row"><div align="left" class="style22 style28">Patient Name  : </div></td>
                ...
                <tr>
                  <td height="35" bgcolor="#FFFFFF" scope="row"><div align="left" class="style22">Select Doctor/User  : </div></td>
                  <td><label>
                ...
                <tr>
                  <td height="35" bgcolor="#FFFFFF" scope="row"><span class="style28"><span class="style24">
