		...
		if ( rs1.next())
		{
			...
			if ( rs.next()==true)
			{
				...
				if(sk.equalsIgnoreCase("Requested"))
				{
					...
					<h3 class="style31">Request Already Sent To (Delgatee) </h3>
					<p class="style28">&nbsp;</p>
					<%
				}
				else
			...
			else
			{
				...
				%>
				<h3 class="style31">Request Sent To (Delgatee) </h3>
				<p class="style28">
				<%
				
				connection.createStatement().executeUpdate("insert into hkas_transaction (user,patient,provider,doctor,status) values('"+doc+"(Delegator)', '"+patient+"','"+provider+"', 'Delgatee' ,'Requested Key')");
