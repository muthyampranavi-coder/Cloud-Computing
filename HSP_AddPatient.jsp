...
<div class="main">
  ...
  <div class="content">
	...
	if(rs.next())
	{
			...
			{
				%>
				<h3>  <span class="style20">Wait for Delgatee to generate <br />
				     encryption key</span> !! <br />
				<br /><br /><br /><br /><br /></h3>
			...
			{
				%>
				<h3>  <span class="style20">Wait for Delgatee to Permitt <br /> 
				  encryption key</span> !! <br />
				<br /><br /><br /><br /><br /></h3>
				<a href="HSP_Main.jsp">back</a><br/>
				<%
			...
			{
				%>
				<span class="style20">You Dont Have Encryption Key </span> !!</h3>
				<br />
