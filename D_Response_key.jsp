            ...
            <form action="D_Response_key1.jsp" method="post" id="leavereply">
              <div align="center">
                <table width="523" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <th height="48" scope="row"><div align="center" class="style27"><span class="style17">Enter Provider Name :&nbsp;</span></div></th>
                    <td><div align="left"><span class="style17">
                      <input name="provider" type="text" size="30" />
                    </span></div></td>
                  </tr>
                  <tr>
                    <th height="35" scope="row"><div align="center" class="style27"><span class="style17"> Enter Patient Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div></th>
                    <td><div align="left"><span class="style17">
